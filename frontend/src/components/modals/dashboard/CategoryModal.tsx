...
const CreateCategoryModal = () => {
  ...
  return (
    <div className="h-[100vh] bg-[#16161639] inset-0 backdrop-blur-sm w-full fixed top-0 left-0 z-[5000] flex items-end lg:items-center justify-end md:justify-center">
      ...
      >
        <div onClick={() => dispatch(closeCategoryModal())} className="absolute top-4 right-4 text-[#000] cursor-pointer w-12 h-12 flex items-center hover:bg-[#FAF8F5] justify-center text-xl">
          <RxCross2 />
        </div>
        <div className="w-full px-8 flex flex-col">
          <h3 className="text-2xl ">{categoryId ? "Update" : "Create"} your Category</h3>
          <span className="block text-sm text-[#777] max-w-[380px]">Give your Category a name and value, make it concise and brief.</span>
        </div>
