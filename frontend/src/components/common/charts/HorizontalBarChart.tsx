    ...
    <div className="border border-[#e8e6e3] bg-white rounded-lg p-3 flex flex-col gap-1.5 min-w-[180px]">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-base text-[#17191c]">
        ...
        {payload.map((entry) => {
          ...
          return (
            <div key={entry.dataKey} className="flex items-center justify-between gap-4">
              ...
              <span className="text-lg text-[#17191c]">
...
// Shared legend: circle dot + label, wrapping flex row
