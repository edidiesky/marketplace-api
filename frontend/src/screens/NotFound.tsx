    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: "var(--color-fog)" }}>
      <div className="max-w-md w-full bg-white p-10 flex flex-col gap-6">
        <div className="flex flex-col gap-1">
          <p className="font-semibold leading-none" style={{ fontSize: "64px", color: "var(--color-ink)", letterSpacing: "-2px" }}>404</p>
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-[28px] font-semibold leading-[1.1]" style={{ color: "var(--color-ink)", letterSpacing: "-0.5px" }}>
            Page not found
          </h1>
        ...
        <div className="p-4 flex flex-col gap-3 border" style={{ borderColor: "var(--color-stone-surface)", backgroundColor: "var(--color-fog)" }}>
          <p className="text-xs font-semibold uppercase" style={{ color: "var(--color-muted-stone)" }}>Try one of these instead</p>
          {[
            ...
            <div key={s} className="flex items-start gap-3">
              <span className="w-5 h-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5" style={{ backgroundColor: "var(--color-ink)", color: "var(--color-canvas)" }}>{i + 1}</span>
