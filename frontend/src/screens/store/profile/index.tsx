    ...
    <div className="w-full min-h-screen bg-[#FAF8F5]">
      <div className="max-w-4xl mx-auto px-4 lg:px-8 py-12 flex flex-col gap-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-lg  text-[#171717]">{currentUser.firstName} {currentUser.lastName}</p>
        ...
        {activeTab === "profile" && (
          <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="flex flex-col gap-5 max-w-lg">
            ...
            <button type="submit" disabled={updatingProfile} className="h-11 bg-[#171717] text-white text-sm  hover:opacity-90 disabled:opacity-50 w-fit px-6">
                    ...
                    return (
                      <div key={order._id} className="bg-white border border-black/5 p-5 flex flex-col gap-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-sm  text-[#171717]">₦{order.totalAmount.toLocaleString("en-NG")}</p>
                        </div>
        ...
        {activeTab === "password" && (
          <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="flex flex-col gap-5 max-w-lg">
            ...
            <button type="submit" disabled={changingPassword} className="h-11 bg-[#171717] text-white text-sm  hover:opacity-90 disabled:opacity-50 w-fit px-6">
        ...
        {activeTab === "address" && (
          <form onSubmit={addressForm.handleSubmit(onAddressSubmit)} className="flex flex-col gap-5 max-w-lg">
            ...
            <button type="submit" className="h-11 bg-[#171717] text-white text-sm  hover:opacity-90 w-fit px-6">
              Save address
            </button>
          </form>
        )}
