...
router.post("/:id/domain", authenticate, AddCustomDomainHandler)
router.post("/:id/domain/verify", authenticate, VerifyCustomDomainHandler)
router.get("/resolve", ResolveStoreHandler) // public, no auth
