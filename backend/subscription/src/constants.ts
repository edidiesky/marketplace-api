export const SERVICE_NAME = "subscription-service";
...
export const EXCHANGES = {
  ...
  SUBSCRIPTION_DLX: "selleasi.subscription.dlx",
...
export type SubscriptionRoutingKey =
  (typeof ROUTING_KEYS)[keyof typeof ROUTING_KEYS];

export const QUEUES = {
  ORG_ONBOARDING: "selleasi.subscription.org.onboarding.queue",
} as const;
