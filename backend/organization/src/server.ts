...
async function start(): Promise<void> {
  ...
  logger.info("organization_service_started", {
    event:   "organization_service_started",
...
start().catch(async (err) => {
  ...
  logger.error("organization_service_start_failed", {
    event:   "organization_service_start_failed",
    service: SERVICE_NAME,
